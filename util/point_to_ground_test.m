...
robot_ip_addr = "172.26.166.168" # 12AB
robot_ip_addr = "172.26.167.23"  # 5A7B
robot_hostname = "aim-5a7b6818.wifi.local.cmu.edu"
#robot_ip_addr = "192.168.4.1"

robot = Robot(loop=loop, host=robot_hostname)
