...
class SoundActuator(Actuator):
    ...
    #
    # Active selection: Salvatore speaks with a refined Italian accent.
    # Needs ELEVENLABS_API_KEY, and the voice must be in that account's My
    # Voices. Without the key, speech falls back to gTTS and Salvatore still
    # talks, just not in his own voice.
    TTS_API = 'elevenlabs'
    TTS_VOICE = 'yowh82B72eMNrxcxHgBh'  # Lorenzo Prada - Refined Italian accent
    TTS_PARAMS = {
        'model_id': 'eleven_multilingual_v2',
